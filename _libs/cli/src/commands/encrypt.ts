...
export const encryptCommand = buildCommand<{}, [string]>({
    ...
    docs: {
        ...
        fullDescription:
            "Reads .config/purenv-pub.key, encrypts the provided plaintext with ML-KEM-512 + AES-256-GCM, and prints the resulting `encrypted:v1:...` envelope. Paste the output into a .env file as the secret value.",
    },
});
