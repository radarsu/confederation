...
export const keygenCommand = buildCommand({
    func: function () {
        ...
        stdout.write("  - PURENV_PRIVATE_KEY env var (CI / production)\n");
    ...
    docs: {
        ...
        fullDescription:
            "Generates a fresh post-quantum keypair (ML-KEM-512). Writes the public key to .config/purenv-pub.key (commit this), and prints the private key to stdout with storage instructions. Refuses to overwrite an existing public key.",
    },
});
