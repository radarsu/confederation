...
export const decryptCommand = buildCommand<{}, [string]>({
    ...
    docs: {
        ...
        fullDescription:
            "Reads the configured private key (PURENV_PRIVATE_KEY env var, PURENV_PRIVATE_KEY_FILE, or the default key path) and prints the decrypted plaintext of the given encrypted:v1: envelope.",
    },
});
