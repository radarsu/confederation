...
export const rotateCommand = buildCommand<{}, string[]>({
    ...
    docs: {
        ...
        fullDescription:
            "Generates a fresh keypair, decrypts every encrypted value in the given .env files with the current private key, re-encrypts them to the new public key, and overwrites .config/purenv-pub.key. Prints the new private key to redistribute. Requires the current private key.",
    },
});
