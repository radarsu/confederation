...
const BANNER = "// Generated by confederation gen — DO NOT EDIT.";
...
// typed ConfederationConfig interface mirroring the nested, coerced schema shape.
export function generateDts(descriptors: LeafDescriptorPublic[], options: CodegenOptions = {}): string {
    ...
    lines.push(`export interface ConfederationConfig ${renderBranch(buildTree(descriptors), 0)}`);
    return `${lines.join("\n")}\n`;
}
